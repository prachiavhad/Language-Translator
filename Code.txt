...
lab_txt=Label(root,text="Enter The Text", font=("Time New Roman",20,"bold"),fg="Black", bg="Grey")
...
lab_txt=Label(root,text="Here is Translation", font=("Time New Roman",20,"bold"),fg="Black", bg="Grey")
